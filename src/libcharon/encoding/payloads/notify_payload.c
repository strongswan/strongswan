...
ENUM_NEXT(notify_type_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_RESPONSE",
	"RADIUS_ATTRIBUTE");
ENUM_NEXT(notify_type_names, OPTIMIZED_REKEY_SUPPORTED, OPTIMIZED_REKEY, RADIUS_ATTRIBUTE,
	"OPTIMIZED_REKEY_SUPPORTED",
	"OPTIMIZED_REKEY");
ENUM_NEXT(notify_type_names, CHILD_SA_PFS_INFO_SUPPORTED, CHILD_SA_PFS_INFO_SUPPORTED, OPTIMIZED_REKEY,
...
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_R",
	"RADIUS");
ENUM_NEXT(notify_type_short_names, OPTIMIZED_REKEY_SUPPORTED, OPTIMIZED_REKEY, RADIUS_ATTRIBUTE,
	"OPT_REKEY_SUP",
	"OPT_REKEY");
ENUM_NEXT(notify_type_short_names, CHILD_SA_PFS_INFO_SUPPORTED, CHILD_SA_PFS_INFO_SUPPORTED, OPTIMIZED_REKEY,
	"CHILD_PFS_SUP");
