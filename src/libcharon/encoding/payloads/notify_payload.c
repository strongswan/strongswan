...
ENUM_NEXT(notify_type_names, ADDITIONAL_KEY_EXCHANGE, USE_AGGFRAG, INTERMEDIATE_EXCHANGE_SUPPORTED,
	...
	"USE_AGGFRAG");
ENUM_NEXT(notify_type_names, SA_RESOURCE_INFO, OPTIMIZED_REKEY, USE_AGGFRAG,
	"SA_RESOURCE_INFO",
...
ENUM_NEXT(notify_type_short_names, ADDITIONAL_KEY_EXCHANGE, USE_AGGFRAG, INTERMEDIATE_EXCHANGE_SUPPORTED,
	"ADD_KE",
	"AGGFRAG");
ENUM_NEXT(notify_type_short_names, SA_RESOURCE_INFO, OPTIMIZED_REKEY, USE_AGGFRAG,
	"RES_INFO",
	"OPT_REKEY_SUP",
	"OPT_REKEY");
