...
ENUM_NEXT(notify_type_names, SA_RESOURCE_INFO, SA_RESOURCE_INFO, USE_AGGFRAG,
	"SA_RESOURCE_INFO");
ENUM_NEXT(notify_type_names, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, SA_RESOURCE_INFO,
	"IKE_SA_INIT_FULL_TRANSCRIPT_AUTH");
ENUM_NEXT(notify_type_names, INITIAL_CONTACT_IKEV1, INITIAL_CONTACT_IKEV1, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH,
	"INITIAL_CONTACT");
...
ENUM_NEXT(notify_type_short_names, SA_RESOURCE_INFO, SA_RESOURCE_INFO, USE_AGGFRAG,
	"RES_INFO");
ENUM_NEXT(notify_type_short_names, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, SA_RESOURCE_INFO,
	"FULL_TRANSCRIPT");
ENUM_NEXT(notify_type_short_names, INITIAL_CONTACT_IKEV1, INITIAL_CONTACT_IKEV1, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH,
	"INITIAL_CONTACT");
