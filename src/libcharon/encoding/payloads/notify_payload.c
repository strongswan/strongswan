...
ENUM_NEXT(notify_type_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_RESPONSE",
	"RADIUS_ATTRIBUTE");
ENUM_NEXT(notify_type_names, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, RADIUS_ATTRIBUTE,
...
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_R",
	"RADIUS");
ENUM_NEXT(notify_type_short_names, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, IKE_SA_INIT_FULL_TRANSCRIPT_AUTH, RADIUS_ATTRIBUTE,
	"FULL_TRANS");
