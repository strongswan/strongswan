...
struct eap_manager_t {
	 ...
	 */
	void (*add_method)(eap_manager_t *this, eap_type_t type, eap_vendor_t vendor,
	 ...
	 * @return				enumerator over (eap_type_t type, eap_vendor_t vendor)
	 */
	...
	eap_method_t* (*create_instance)(eap_manager_t *this, eap_type_t type,
									 eap_vendor_t vendor, eap_role_t role,
