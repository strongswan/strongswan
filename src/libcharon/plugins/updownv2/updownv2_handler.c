...
typedef struct private_updownv2_handler_t private_updownv2_handler_t;

/**
 * Private data of an updownv2_handler_t object.
 */
struct private_updownv2_handler_t {

	/**
	 * Public updownv2_handler_t interface.
	 */
	updownv2_handler_t public;
...
METHOD(attribute_handler_t, handle, bool,
	private_updownv2_handler_t *this, ike_sa_t *ike_sa,
...
METHOD(updownv2_handler_t, create_dns_enumerator, enumerator_t*,
	private_updownv2_handler_t *this, u_int id)
{
	attributes_t *attr;
	enumerator_t *enumerator;
	ike_sa_t *ike_sa;
...
METHOD(updownv2_handler_t, destroy, void,
	private_updownv2_handler_t *this)
{
