 ...
 * @param user		user data passed to enum_name_get_t, or NULL
 * @param e			enum name for which callback is invoked
 * @param val		enum value to map
 * @return			number of characters written
 */
typedef int (*enum_name_cb_t)(printf_hook_data_t *data, void *user,
							  enum_name_t *e, int val);
 ...
 *
 * Arguments are:
 *	enum_name_get_t getter, void *user, int value
 */
