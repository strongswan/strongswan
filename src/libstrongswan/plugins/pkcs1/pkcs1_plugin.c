	...
	static plugin_feature_t f[] = {
		...
		PLUGIN_REGISTER(PUBKEY, pkcs1_public_key_load, FALSE),
			PLUGIN_PROVIDE(PUBKEY, KEY_ANY),
				...
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA44_RSA2048_PSS),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA44_RSA2048_PKCS15),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA44_ED25519),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA44_ECDSA_P256),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_RSA3072_PSS),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_RSA3072_PKCS15),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_RSA4096_PSS),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_RSA4096_PKCS15),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_ECDSA_P256),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_ECDSA_P384),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_ECDSA_BPP256R1),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA65_ED25519),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA87_ECDSA_P384),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA87_ECDSA_BPP384R1),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA87_ED448),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA87_RSA3072_PSS),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA87_RSA4096_PSS),
				PLUGIN_SDEPEND(PUBKEY, KEY_MLDSA87_ECDSA_P521),
		PLUGIN_REGISTER(PUBKEY, pkcs1_public_key_load, FALSE),
