...
/**
 * Precalculated Zeta^BitRev_8(i) mod q values for NTT Algorithms 411 and 42
 * (see Appendix B in FIPS 204).
 */
...
{
	u_int start, len, j, k = 256;
	int32_t t, zeta;

	/* scaling factor */
	const int32_t factor = 41978; /* mont^2/256 */
 ...
 * Described in header
 */
void ml_dsa_poly_reduce_vec(uint k, ml_dsa_poly_t *a)
{
	int32_t r;
	u_int n;
 ...
 * Described in header
 */
void ml_dsa_poly_cond_add_q_vec(uint k, ml_dsa_poly_t *a)
{
	u_int n;
 ...
 * Described in header
 */
void ml_dsa_poly_power2round_vec(uint k, ml_dsa_poly_t *a,  ml_dsa_poly_t *a0,
										 ml_dsa_poly_t *a1)
{
	int32_t t0, t1;
	u_int n;
 ...
 * Described in header
 */
void ml_dsa_poly_decompose_vec(uint k, ml_dsa_poly_t *a,  ml_dsa_poly_t *a0,
 ...
 * Described in header
 */
void ml_dsa_poly_use_hint_vec(uint k, ml_dsa_poly_t *a,  ml_dsa_poly_t *h,
									  ml_dsa_poly_t *a1, int32_t gamma2)
{
	u_int n;
 ...
 * Described in header
 */
u_int ml_dsa_poly_make_hint_vec(uint k, ml_dsa_poly_t *a0,  ml_dsa_poly_t *a1,
