 ...
 */
static void encrypt_block(const private_twofish_crypter_t *this, const unsigned char in_blk[], unsigned char out_blk[])
 ...
 */
static void decrypt_block(const private_twofish_crypter_t *this, const unsigned char in_blk[], unsigned char out_blk[])
{   u_int32_t        locals(b0, b1);
